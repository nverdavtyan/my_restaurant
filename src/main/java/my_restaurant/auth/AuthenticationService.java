package my_restaurant.auth;

import my_restaurant.config.JwtService;
import my_restaurant.token.Token;
import my_restaurant.token.TokenRepository;
import my_restaurant.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    // If no existing user was found, continue with user creation
